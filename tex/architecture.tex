...
%
Here the query is rewritten according to the \emph{PostgreSQL Rule System}, which is a collection of rules on how to rewrite queries, such that they are optimized for PostgreSQL. \remark{Unclear}
%
...
\remark{more information on this?}
...
%
\remark{Add some more information?}
...
\remark{This part is unclear. Why do we need the stack? What is its purpose? What information is on the stack?}
